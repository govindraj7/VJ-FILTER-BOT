...
API_ID = int(environ.get('API_ID', '24191145'))
API_HASH = environ.get('API_HASH', '0c36521ebcad047d82a7a00430ee8780')
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002223390672'))
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '2071372702').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002108260965').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://shashank:thanos2006@cluster0.qmqabf0.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
